...
//       const operationType =
//         node.firstElementChild!.getAttribute('data-type') === 'attack'
//           ? OperationType.ARMY_ATTACK
//           : OperationType.ARMY_SUPPORT;
//       const attackTypeSelector =
//         operationType === OperationType.ARMY_ATTACK
//           ? `[data-attack='${(document.querySelector('.attack_type.checked') as HTMLElement)?.dataset['attack']}']`
//           : undefined;
...
//             el => el.textContent?.trim() === schedulerItem.id,
//           );
//           if (!dropdownItem) {
...
//           const targetCityElement = await waitForElementInterval(targetCitySelector, {
//             interval: 500,
//             retries: 5,
//           }).catch(() => {
...
//             attackTypeSelector &&
//               (await waitForElementInterval(attackTypeSelector, { interval: 500, timeout: 2000 }).then(el =>
//                 (el as HTMLElement).click(),
//               ));
//             console.log('attackTypeSelector clicked', document.querySelector<HTMLElement>(attackTypeSelector!));
//             attackStrategySelector &&
//               (await waitForElementInterval(attackStrategySelector, { interval: 500, timeout: 2000 }).then(el =>
//                 (el as HTMLElement).click(),
//               ));
...
//               await waitForElementInterval(powerSelector, { interval: 500, timeout: 2000 }).then(el =>
//                 (el as HTMLElement).click(),
//               );
...
//     if (
//       schedulerItem.operationType === OperationType.ARMY_ATTACK ||
//       schedulerItem.operationType === OperationType.ARMY_SUPPORT
//     ) {
...
//           console.log(
//             '\t:',
//             item.actionDate.getTime() - actionDate.getTime(),
//             (item.actionDate.getTime() - actionDate.getTime()) / 1000,
//           );
//           return true;
//         }
...
//       this.scheduler.every(item => item.actionDate > new Date(new Date().getTime() + 120 * 1000))
//     );
//   }
// }
